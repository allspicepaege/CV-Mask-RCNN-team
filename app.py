...
- **Первая страница**: Детекция лиц с последующей маскировкой детектированной области (Модель YOLO11)🙈
- **Вторая страница**: Детекция судов на изображениях аэросъёмки (Модель YOLO)⛴️
- **Третья страница**: Семантическая сегментация аэрокосмических снимков (Модель Unet)🌌
